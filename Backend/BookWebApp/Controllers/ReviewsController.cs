    ...
    */
    ...
    public class ReviewsController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetAll(int authorId, int bookId)
        {
            ...
            return Ok(reviews.Select(o => new ReviewDto(o.Id, o.Content, o.CreationDate, o.Book, o.UserId)));
        }
        ...
        public async Task<ActionResult<ReviewDto>> GetOne(int authorId, int bookId, int reviewId)
        {
            ...
            return new ReviewDto(review.Id, review.Content, review.CreationDate, review.Book, review.UserId);
        }
        ...
        public async Task<ActionResult<ReviewDto>> Create(int authorId, int bookId, CreateReviewDto createReviewDto)
        {
            ...
            // 201
            return Created("", new ReviewDto(review.Id, review.Content, review.CreationDate, review.Book, review.UserId));
        }
        ...
        public async Task<ActionResult<ReviewDto>> Update(int authorId, int bookId, int reviewId, UpdateReviewDto updateReviewDto)
        {
            ...
            return Ok(new ReviewDto(review.Id, review.Content, review.CreationDate, review.Book, review.UserId));
        }
