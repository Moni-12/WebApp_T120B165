        ...
        {author && (
          ...
          <div className="mt-4 flex items-center justify-center">
            {author.pictureBase64 !== null && author.pictureBase64 !== "" &&(
               ...
               src={author.pictureBase64}
               alt="Uploaded"
             />
            )}
            {author.pictureBase64 === null || author.pictureBase64 === "" && (
                          <svg fill="#000000" height="192px" width="192px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
          ...
          <div className="mt-5 border-t border-gray-200">
            <dl className="sm:divide-y sm:divide-gray-200">
              ...
              {isAdmin && (
                ...
                <a href={`/author/${author.id}/create-book`} className="text-white text-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                  Add book
                </a>
                </div>
          )}
